 ...
 * NASIL: pwa-hazirla.mjs __KARTAKIL_BUILD__ yer tutucusunu export HTML'inin kısa SHA-256 özetiyle değiştirir.
 * YAN ETKİ: Yeni deploy eski KartAkıl kabuk cache'ini temizler; Supabase ve diğer projelerin cache'lerine dokunmaz.
 */
const CACHE = "kartakil-kabuk-__KARTAKIL_BUILD__";
